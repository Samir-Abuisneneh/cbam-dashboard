...
see §7, where the China green ammonia case is a real example of why this matters).
...
Nothing in either original brief specified how many tonnes a voyage actually carries.
This was a real gap, closed on 25 July when Gayu delivered her cargo-capacity notebook.
...
- `run_model.ipynb`: the entry point, produces every output end to end.
